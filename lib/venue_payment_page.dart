...
class VenuePaymentPage extends StatefulWidget {
  final Map<String, dynamic> booking;

  const VenuePaymentPage({Key? key, required this.booking}) : super(key: key);
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildSummaryRow('Venue', widget.booking['venueName'] ?? 'Unknown Venue'),
          _buildSummaryRow('Court', widget.booking['courtName'] ?? 'Court ${widget.booking['courtNumber'] ?? 'N/A'}'),
          _buildSummaryRow('Type', widget.booking['courtType'] ?? 'Standard Court'),
          _buildSummaryRow('Date', widget.booking['date'] ?? 'N/A'),
          _buildSummaryRow('Time', '${widget.booking['timeSlot']} - ${widget.booking['endTime']}'),
          _buildSummaryRow('Duration', '${widget.booking['duration']} hour(s)'),
          _buildSummaryRow('Rate', 'RM ${widget.booking['pricePerHour']}/hour'),
